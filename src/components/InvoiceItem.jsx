...
return (
    ...
    {/* Cell for the item name */}
      ...
      {/* Cell for the item price */}
      <td className="relative min-w-[100px] md:min-w-[150px]">
      {/* Icon to indicate a numerical input for price */}
        <svg
        ...
        {/* InvoiceField component for editing the price */}
      ...
      {/* Cell with a button to delete the item */}
