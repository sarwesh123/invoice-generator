...
// Functional component InvoiceModal with destructured props.
const InvoiceModal = ({
  isOpen,
  setIsOpen,
  invoiceInfo,
  ...
  // Function to close the modal by setting isOpen state to false.
  function closeModal() {
    setIsOpen(false);
  }

  // Handler for adding the next invoice.
  const addNextInvoiceHandler = () => {
    setIsOpen(false);
    onAddNextInvoice();
  };
  // Handler for saving the invoice as a PDF.
  const SaveAsPDFHandler = () => {
    // Get the DOM element with id 'print' (the content to be converted to PDF).
    const dom = document.getElementById("print");
    // Use html-to-image library to convert the content to a PNG image.
    toPng(dom)
      .then((dataUrl) => {
        ...
        img.src = dataUrl;
        // When the image is loaded, initialize the PDF.
        img.onload = () => {
          // Initialize the PDF.
          const pdf = new jsPDF({
          ...
          // Loop through pages, trim the final page, and add each page to the PDF.
  ...
  // JSX for rendering the modal using @headlessui components and tailwindcss classes.
        ...
        <div className="min-h-screen px-4 text-center">
          ...
          >
            <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
              ...
              {/* Buttons for downloading PDF and moving to the next invoice. */}
